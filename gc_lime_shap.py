...
Somente rodar uma vez antes do passo 2.2
"""
...
Executar uma vez por classe. 
Mudar ``` CLASSE_ALVO ``` para o nome da classe que quer aplicar o Grad-CAM++
"""
...
Se usar o Colab - Sempre rodar assim que abrir
"""
...
Para mudar a classe, somente editar ``` CLASSE_ALVO ```
"""
...
O que ela mostra: Duas imagens coladas. A original e a explicada.

Por que usar: É a melhor para slides. Ela evita que você a alternância de imagens. Mostra o tumor original e, ao lado, prova que o LIME "circulou" exatamente aquela massa.


---
Opção 2: O "Prós e Contras" (Diagnóstico profundo)

O que ela mostra: Uma imagem com bordas de duas cores (geralmente verde para o que confirma a classe e vermelho para o que confunde o modelo).
...
O que ela mostra: Tudo o que não é importante desaparece (fica preto). Sobram apenas os "pedaços" que o modelo considerou cruciais.
